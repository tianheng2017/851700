...
return	array(	
	'system'=>array('name'=>'系统','child'=>array(
				array('name' => '设置','child' => array(
						...
						//array('name' => '公告管理', 'act'=>'noticeList', 'op'=>'Article'),
				...
				array('name' => '会员','child'=>array(
						...
						array('name'=>'鱼分提现','act'=>'score_tx','op'=>'User'),
						array('name'=>'汇款记录','act'=>'remittance','op'=>'User'),
						//array('name'=>'鱼分返还','act'=>'give_score','op'=>'User'),
				)),
...
/*					array('name' => '预售管理','act'=>'pre_sell_list', 'op'=>'Promotion'),*/
			...
			array('name' => '活动','child' => array(
					array('name' => '活动商品列表', 'act'=>'goods_list', 'op'=>'Distribut'),
					array('name' => '活动商列表', 'act'=>'distributor_list', 'op'=>'Distribut'),
					array('name' => '活动关系', 'act'=>'tree', 'op'=>'Distribut'),
					array('name' => '活动设置', 'act'=>'set', 'op'=>'Distribut'),
