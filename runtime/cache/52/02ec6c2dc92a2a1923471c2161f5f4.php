<?php
//000000000000s:26314:"<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
    ...
    <div class="layout">
        ...
        <div class="t1-r">
            <ul class="t1-r-ul islogin" style="display:none;">
                ...
                <li class="t1img"><a href="/Home/user/logout.html">安全退出</a></li>                    
                <li class="t1img">&nbsp;</li>
                <li class="t1img">&nbsp;</li>                
    ...
    <!-- 搜索开始-->
        <div class="searchBar">
            ...
            <div class="searchBar-hot">
                <b>热门搜索</b>
               	        			<a target="_blank" href="/Home/Goods/search/q/%E6%89%8B%E6%9C%BA.html" class="ht">手机</a>
        		        			<a target="_blank" href="/Home/Goods/search/q/%E5%B0%8F%E7%B1%B3.html" >小米</a>
        		        			<a target="_blank" href="/Home/Goods/search/q/iphone.html" >iphone</a>
        		        			<a target="_blank" href="/Home/Goods/search/q/%E4%B8%89%E6%98%9F.html" >三星</a>
        		        			<a target="_blank" href="/Home/Goods/search/q/%E5%8D%8E%E4%B8%BA.html" >华为</a>
        		        			<a target="_blank" href="/Home/Goods/search/q/%E5%86%B0%E7%AE%B1.html" >冰箱</a>
        		            </div>
        </div>
        <!-- 搜索结束-->
        	...
        	<div class="allgoods">
            	...
            	<div class="list"  >
                   <ul class="list_ul"> 
                                ...
                                <li class="list-li">
                                    <div class="list_a">
                                        <h3><a href="/Home/Goods/goodsList/id/845.html"><span>商品套餐</span></a></h3>
    ...
    <div class="item fl">
      <div class="fl">
        <span class="u-nav-title">
                      <a href="/Home/Goods/goodsList.html"></a>
                    </span>
      </div>
  ...
  <div class="searchbox">
    <div class="list clearfix">
      <ul class="left text12" id="order_ul">
        ...
        <li> <a class="col7ac  main" href="/Home/Goods/goodsList/id/118" style="cursor:pointer;"> 默认 </a> </li>
        <li> <a class="col7ac  " href="/Home/Goods/goodsList/id/118/sort/sales_sum" style="cursor:pointer;"> 销量 </a> </li>
                
                	<li><a class="col7ac  " href="/Home/Goods/goodsList/id/118/sort/shop_price/sort_asc/desc" style="cursor:pointer;">价格<span class="icon_s "></span></a></li>
            
                
        <li><a class="col7ac  " href="/Home/Goods/goodsList/id/118/sort/comment_count" style="cursor:pointer;">评论</a></li>
        <li><a class="col7ac  "  href="/Home/Goods/goodsList/id/118/sort/is_new" style="cursor:pointer;">新品</a></li>
      </ul>
      <!-- Page -->
