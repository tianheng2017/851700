<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"./application/admin/view2/distribut\rebate_log.html";i:1583655600;s:44:"./application/admin/view2/public\layout.html";i:1495107356;}*/ ?>
<!doctype html>
<html>
<head>
      ...
      <div id="flexigrid" cellpadding="0" cellspacing="0" border="0">
			...
			<?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
		        	<tr>
					  ...
					  <td align="center" abbr="article_time" axis="col6" class="">
		                <div style="text-align: center; width: 200px;" class=""><?php echo $v['remark']; ?></div>
		              </td>
		              <td align="center" abbr="article_time" axis="col6" class="">
